...
class DisplayDemoNewWidget extends StatefulWidget {
  DisplayDemoNewWidget({Key key, this.title}) : super(key: key);
  final String title;

  @override
  DisplayDemoNewWidgetState createState() => DisplayDemoNewWidgetState();
}

class DisplayDemoNewWidgetState extends State<DisplayDemoNewWidget>{
  ImageBean testBean = new ImageBean();//保存数据的泛型实体
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: new ListView(
          ...
          children: <Widget>[
            GridPictureDisplayWidget(context,testBean, 2,360,5),
            GridPictureDisplayWidget(context,testBean, 3,360,5),
            GridPictureDisplayWidget(context,testBean, 4,360,5),
            GridPictureDisplayWidget(context,testBean, 5,360,5),
            GridPictureDisplayWidget(context,testBean, 6,360,5),
          ],
        ));
  }
